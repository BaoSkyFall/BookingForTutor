...
export default class TutorOfMonth extends Component {
  render() {
    return (
      <div>
                ...
                <div className="item">
                  <div className="testi-content text-center m-3 p-4 position-relative">
                    ...
                    <p className="text-muted mb-4 position-relative f-15">
                      Et harum quidem that rerum facilis expedita distinctio nam
                      at what libero tempore cum soluta nobis est eligendi.
                    </p>
                    <img
