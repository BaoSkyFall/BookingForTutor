...
import Chart from "../../../public/bower_components/chart.js/Chart.js";
            ...
            <div className="row">
              ...
              <div className="col-md-8">
                        ...
                        <div className="direct-chat-messages">
                          ...
                          <div className="direct-chat-msg">
                            <div className="direct-chat-info clearfix">
                              <span className="direct-chat-name pull-left">{this.props.user}</span>
                  ...
                  <div className="col-md-6">
                    ...
                    <div className="box box-danger">
                      ...
                      <div className="box-body no-padding">
                        <ul className="users-list clearfix">
                          <li>
                            ...
                            <a className="users-list-name" href="fake_url">{this.props.user}</a>
                      ...
                      <div className="box-footer text-center">
                        <a alt="fake_js_url" className="uppercase">View All Users</a>
                      </div>
                      {/* /.box-footer */}
                    </div>
                    {/*/.box */}
                ...
                <div className="box box-info">
                  ...
                  <div className="box-footer clearfix">
                    <a alt="fake_js_url" className="btn btn-sm btn-info btn-flat pull-left">Place New Order</a>
                    <a alt="fake_js_url" className="btn btn-sm btn-default btn-flat pull-right">View All Orders</a>
                  </div>
                  {/* /.box-footer */}
                </div>
                {/* /.box */}
              ...
              <div className="col-md-4">
                ...
                <div className="box box-default">
                  ...
                  <div className="box-footer no-padding">
                    <ul className="nav nav-pills nav-stacked">
                      <li><a href="fake_url">United States of America
                          <span className="pull-right text-red"><i className="fa fa-angle-down" /> 12%</span></a></li>
                      <li><a href="fake_url">India <span className="pull-right text-green"><i className="fa fa-angle-up" /> 4%</span></a>
                      </li>
                      <li><a href="fake_url">China
                ...
                <div className="box box-primary">
                    ...
                    <ul className="products-list product-list-in-box">
                      <li className="item">
                        ...
                        <div className="product-info">
                          <a alt="fake_js_url" className="product-title">Samsung TV
                      ...
                      <li className="item">
                        ...
                        <div className="product-info">
                          <a alt="fake_js_url" className="product-title">Bicycle
                      ...
                      <li className="item">
                        ...
                        <div className="product-info">
                          <a alt="fake_js_url" className="product-title">Xbox One <span className="label label-danger pull-right">$350</span></a>
                          <span className="product-description">
                      ...
                      <li className="item">
                        ...
                        <div className="product-info">
                          <a alt="fake_js_url" className="product-title">PlayStation 4
                  ...
                  {/* /.box-body */}
                  <div className="box-footer text-center">
                    <a alt="fake_js_url" className="uppercase">View All Products</a>
                  </div>
                  {/* /.box-footer */}
                </div>
                {/* /.box */}
